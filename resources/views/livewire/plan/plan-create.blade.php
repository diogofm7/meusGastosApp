<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <form action="" wire:submit.prevent="createPlan" class="w-full max-w-7xl mx-auto">
        <div class="flex flex-wrap mx-3 mb-6">
            ...
            <p class="w-full px-3">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1">Nome Plano</label>
            ...
            <p class="w-full px-3 mt-6">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1">Descrição Plano</label>
            ...
            <p class="w-full px-3 mt-6">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1">Valor do Plano</label>
            ...
            <p class="w-full px-3 mt-6">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1">Apelido Plano</label>
        ...
        <div class="w-full py-4 px-3 mb-6">
            ...
            <button type="submit" wire:loading.attr="disabled" wire:target="createPlan" wire:loading.class.remove="bg-teal-500" wire:loading.class="bg-gray-500"
                    class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded">

                <span wire:loading.remove wire:target="createPlan">Criar Plano</span>
                <span wire:loading wire:target="createPlan">Cadastrando ...</span>
